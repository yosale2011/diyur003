...
### שינויים אחרונים
1. תיקון rotation של סגמנטים - כשדיווח מתחיל לפני הסגמנט הראשון
2. תיקון נרמול זמנים בבדיקת שבת
3. תיקון carryover בין ימים לא רציפים
4. הוספת תמיכה במשמרות תגבור
